...
export { FLASK_COLOR_VARS, FLASK_COLORS, mulberry32, pickFlaskColor };
...
// Flask colour palette + picker live in `./flaskColors.ts`. mulberry32 lives in
// `@/lib/utils/mulberry32.ts`. Both are re-exported at the top of this file so
// callers (tests, outro modules, PhysicsScene) keep resolving from here.

// chainLength / segmentsForLength live in `./constants.ts` (overlap-aware
// chain geometry, shared with createChainBodies + FlaskChain). Re-exported.
export { chainLength };
